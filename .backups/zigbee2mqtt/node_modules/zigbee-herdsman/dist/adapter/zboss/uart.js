...
class ZBOSSUart extends stream_1.default {
    ...
    async onPackage(data) {
        ...
        logger_1.logger.debug(`<-- package type ${pType}, flags ${pFlags.toString(16)}` + `${JSON.stringify({ isACK, retransmit, sequence, ACKseq, isFirst, isLast })}`, NS);
    ...
    async sendFrame(frame) {
        try {
            const buf = (0, frame_1.writeZBOSSFrame)(frame);
