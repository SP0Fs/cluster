...
class Endpoint extends entity_1.default {
    ...
    async bind(clusterKey, target) {
        ...
        try {
            await entity_1.default.adapter.bind(this.deviceNetworkAddress, this.deviceIeeeAddress, this.ID, cluster.ID, destinationAddress, type, target instanceof Endpoint ? target.ID : undefined);
            this.addBindingInternal(cluster, target);
        }
        catch (error) {
            const err = error;
    ...
    async unbind(clusterKey, target) {
        ...
        logger_1.logger.debug(log, NS);
        try {
            await entity_1.default.adapter.unbind(this.deviceNetworkAddress, this.deviceIeeeAddress, this.ID, cluster.ID, destinationAddress, type, target instanceof Endpoint ? target.ID : undefined);
