...
exports.FRAMES = {
    ...
    [enums_2.CommandId.ZDO_NWK_ADDR_REQ]: {
        request: [
        ...
        response: [
            ...
            { name: 'ieee', type: enums_1.DataType.IEEE_ADDR },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'num', type: enums_1.DataType.UINT8, condition: (payload, buffalo) => buffalo && buffalo.isMore() },
            { name: 'startIndex', type: enums_1.DataType.UINT8, condition: (payload, buffalo) => buffalo && buffalo.isMore() },
            { name: 'nwks', type: enums_1.BuffaloZclDataType.LIST_UINT16, options: (payload, options) => (options.length = payload.num) },
        ],
    },
    // Request for a remote device IEEE address
    [enums_2.CommandId.ZDO_IEEE_ADDR_REQ]: {
        request: [
            { name: 'destNwk', type: enums_1.DataType.UINT16 },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'type', type: enums_1.DataType.UINT8 },
            { name: 'startIndex', type: enums_1.DataType.UINT8 },
        ],
    ...
    [enums_2.CommandId.ZDO_POWER_DESC_REQ]: {
        request: [{ name: 'nwk', type: enums_1.DataType.UINT16 }],
        response: [...commonResponse, { name: 'powerDescriptor', type: enums_1.DataType.UINT16 }, { name: 'nwk', type: enums_1.DataType.UINT16 }],
    },
    // Get the Node Descriptor from a remote device
    [enums_2.CommandId.ZDO_NODE_DESC_REQ]: {
        request: [{ name: 'nwk', type: enums_1.DataType.UINT16 }],
        response: [
            ...commonResponse,
            { name: 'flags', type: enums_1.DataType.UINT16 },
            { name: 'macCapabilities', type: enums_1.DataType.UINT8 },
            { name: 'manufacturerCode', type: enums_1.DataType.UINT16 },
            { name: 'bufferSize', type: enums_1.DataType.UINT8 },
            { name: 'incomingSize', type: enums_1.DataType.UINT16 },
            { name: 'serverMask', type: enums_1.DataType.UINT16 },
            { name: 'outgoingSize', type: enums_1.DataType.UINT16 },
            { name: 'descriptorCapabilities', type: enums_1.DataType.UINT8 },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
        ],
    },
    // Get the Simple Descriptor from a remote device
    [enums_2.CommandId.ZDO_SIMPLE_DESC_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'endpoint', type: enums_1.DataType.UINT8 },
        ],
    ...
    [enums_2.CommandId.ZDO_ACTIVE_EP_REQ]: {
        request: [{ name: 'nwk', type: enums_1.DataType.UINT16 }],
        response: [
            ...commonResponse,
            { name: 'len', type: enums_1.DataType.UINT8 },
            { name: 'endpoints', type: enums_1.BuffaloZclDataType.LIST_UINT8, options: (payload, options) => (options.length = payload.len) },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
        ],
    },
    // Send Match Descriptor request to a remote device
    [enums_2.CommandId.ZDO_MATCH_DESC_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'profileID', type: enums_1.DataType.UINT16 },
            { name: 'inputClusterCount', type: enums_1.DataType.UINT8 },
    ...
    [enums_2.CommandId.ZDO_BIND_REQ]: {
        request: [
            { name: 'target', type: enums_1.DataType.UINT16 },
            { name: 'srcIeee', type: enums_1.DataType.IEEE_ADDR },
            { name: 'srcEP', type: enums_1.DataType.UINT8 },
            { name: 'clusterID', type: enums_1.DataType.UINT16 },
            { name: 'addrMode', type: enums_1.DataType.UINT8 },
            { name: 'dstIeee', type: enums_1.DataType.IEEE_ADDR },
            { name: 'dstEP', type: enums_1.DataType.UINT8 },
        ],
        response: [...commonResponse],
    },
    // Send Unbind request to a remote device
    [enums_2.CommandId.ZDO_UNBIND_REQ]: {
        request: [
            { name: 'target', type: enums_1.DataType.UINT16 },
            { name: 'srcIeee', type: enums_1.DataType.IEEE_ADDR },
            { name: 'srcEP', type: enums_1.DataType.UINT8 },
    ...
    [enums_2.CommandId.ZDO_MGMT_LEAVE_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'ieee', type: enums_1.DataType.IEEE_ADDR },
    ...
    [enums_2.CommandId.ZDO_PERMIT_JOINING_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'duration', type: enums_1.DataType.UINT8 },
            { name: 'tcSignificance', type: enums_1.DataType.UINT8 },
        ],
        response: [...commonResponse],
    },
    // Device announce indication
    [enums_2.CommandId.ZDO_DEV_ANNCE_IND]: {
        request: [],
        response: [],
        indication: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
    ...
    [enums_2.CommandId.ZDO_MGMT_BIND_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'startIndex', type: enums_1.DataType.UINT8 },
        ],
    ...
    [enums_2.CommandId.ZDO_MGMT_LQI_REQ]: {
        request: [
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'startIndex', type: enums_1.DataType.UINT8 },
        ],
        response: [
            ...commonResponse,
            { name: 'entries', type: enums_1.DataType.UINT8 },
            { name: 'startIndex', type: enums_1.DataType.UINT8 },
            { name: 'len', type: enums_1.DataType.UINT8 },
            {
                name: 'neighbors',
                ...
                typed: [
                    ...
                    { name: 'joining', type: enums_1.DataType.UINT8 },
                    { name: 'depth', type: enums_1.DataType.UINT8 },
    ...
    [enums_2.CommandId.ZDO_MGMT_NWK_UPDATE_REQ]: {
        request: [
            { name: 'channelMask', type: enums_1.DataType.UINT32 },
            { name: 'duration', type: enums_1.DataType.UINT8 },
            { name: 'count', type: enums_1.DataType.UINT8 },
            { name: 'managerNwk', type: enums_1.DataType.UINT16 },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
        ],
        response: [...commonResponse],
    },
    ...
    [enums_2.CommandId.ZDO_DEV_AUTHORIZED_IND]: {
        ...
        indication: [
            { name: 'ieee', type: enums_1.DataType.IEEE_ADDR },
            { name: 'nwk', type: enums_1.DataType.UINT16 },
            { name: 'authType', type: enums_1.DataType.UINT8 },
            { name: 'authStatus', type: enums_1.DataType.UINT8 },
        ],
    },
