...
exports.ZiGateMessage = {
    ...
    [constants_1.ZiGateMessageCode.SimpleDescriptorResponse]: {
        response: [
            { name: 'sourceEndpoint', parameterType: parameterType_1.default.UINT8 }, //<source endpoint: uint8_t>
            { name: 'profile ID', parameterType: parameterType_1.default.UINT16 }, // <profile ID: uint16_t>
            { name: 'clusterID', parameterType: parameterType_1.default.UINT16 }, // <cluster ID: uint16_t>
            { name: 'attributeList', parameterType: parameterType_1.default.LIST_UINT16 }, // <attribute list: data each entry is uint16_t>
        ],
    },
    [constants_1.ZiGateMessageCode.ManagementLQIResponse]: {
        response: [
            ...
            { name: 'NWKAddress', parameterType: parameterType_1.default.UINT16 }, // NWK Address : uint16_t
            ...
            // (1-On 0-Off)
            { name: 'srcAddress', parameterType: parameterType_1.default.UINT16 }, // <Src Address : uint16_t> ( only from v3.1a)
        ],
    },
